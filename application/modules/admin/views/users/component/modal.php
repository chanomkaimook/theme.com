<div id="modal_user" class="modal" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
    <style>
        @media print {
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            ...
            <form class="form-horizontal" id="frm">
                ...
                <input type="hidden" name="hidden_form_admin" value="1"> <!-- set 1 for default value check -->
...
<script>
    $(document).ready(function() {
        ...
        if ($('[data-plugin=jstree_checkbox]').length) {
