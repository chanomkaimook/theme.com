    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <button type="button" class="btn btn-primary" onclick="printDiv('modal_ticket')">ปริ้นใบงาน</button>
            </div>
            <!-- Form -->
...
<script>
    ...
    function submitUpdateTicket() {
        ...
        let catagory_id = modal.find('[name=ticket_catagory_id]').val()
        let catagory_name = modal.find('[name=ticket_catagory_name]').val()
        ...
        data.append('catagory_id', catagory_id)
        data.append('catagory_name', catagory_name)
            ...
            .then((resp) => {
                ...
                if (resp) {
                    ...
                    modal
                        ...
                        .end()
                        .find('.ticket_tech_department').text(item.CATAGORY_NAME)
                        .end()
                    ...
                    // input form
                    modal
                        .find('[name=ticket_catagory_id]').val(item.CATAGORY_ID)
                        .end()
                        .find('[name=ticket_catagory_name]').val(item.CATAGORY_NAME)
                        .end()
                    ...
                    // 1=waite
                    // 2=in process
                    if (item.WORKSTATUS_ID == 1 || item.WORKSTATUS_ID == 2) {
                        footerBtn_showEdit()
                    }

                    //
                    // # Helpdesk permit
                    if ($('#hidden_user_rolelevel').val() == 11 && $('#hidden_user_id').val() != item.STAFF_ID) {
                        footerBtn_show()
                    }
                }
